...
const doc = new jsPDF();
const DefaultHeader = React.lazy(() => import("../../../containers/DefaultLayout/DefaultHeaderUnauthorized.js"));
...
class UnauthorizedAppointment extends Component {
...
const url1 = "/service/get_workspace_details/";
    BaseService.GetDataWithParamsWithoutHeader(url1,param)
      .then((res) => {
      ...
      if(res.data!==undefined)
        ...
        localStorage.setItem('place',res.data.data.place);
        localStorage.setItem('logo',res.data.data.logo)
          ...
          Swal.fire({
            ...
            icon: 'error',
            title: 'Oops...',
            text: 'Error retreiving data! '+res.response.data["description"],
...
getEmployeeData=()=>{
  this.state.workspaceArray.employees.map(async(value)=>{
  ...
  OnTimerComplete=({ hours, minutes, seconds, completed })=>{
if (completed) {
    // Render a completed state
     this.setState({
large:false
    ...
    return  <span>Sorry...Times Up!</span>;
  } else {
    // Render a countdown

    return <span   style={{color:"red",paddingLeft:"100px"}}>Idle Time:- {minutes} min:{seconds} sec</span>;
  }
  }
...
onAppUpdate=()=>{
  ...
  eventInfo=()=>{
    ...
    BaseService.GetDataWithParamsWithoutHeader(url2, paramdata)
      .then(async(res2) => {
...
eventClickModelFunction=()=>{
  ...
  GetServiceAndClient = () => {
    ...
    // const url1 = "/service/get_workspace_details/?workspace_id=2";
  ...
  appointmentSubmit = (e) => {
    ...
    (this.state.fullnameInput !== "" || this.state.clientID !== "")) {
      if (this.state.setdisable === true) {
        ...
        const url = "/appointment/invalidated_save/";
        BaseService.PostServiceWithoutHeader(url, data)
          .then((res) => {
...
console.log(tab)
  ...
  const newArray = this.state.activeTab.slice();
      ...
      Swal.fire({
        ...
        icon: "error",
        title: "Oops...",
        text: "Please provide valid phone number! eg:- +94771234567",
      });
...
alertify.message('we are checking availability...');
          ...
          const url = "/appointment/invalidated_check/";
          BaseService.PostServiceWithoutHeader(url, data)
            .then((res) => {
              document.getElementById("submitbtn").disabled=false;
              document.getElementById("resetbtn").disabled=false;
...
{this.state.arrayVal.length === 1 && this.state.appdate!==""?
<div className="pull-right">
                  <i class="motion fa fa-arrow-down pr-3" aria-hidden="true"></i>
                <strong>Fill the appointments. You can add more than one</strong>
              </div>
:<></>}
  ...
  className={this.state.arrayVal[index] && this.state.arrayVal.length > 1?'ondisable':<></>}                          >
    ...
    disabled={this.state.arrayVal[index]}
     onChange={(e,{value}) => {this.onDropDownChange(value,index)
                              ...
                              this.checkSlotWithEmployee(value)
                            }}
  />
                        </FormGroup>
...
:<></>}
  ...
  onDropDownChange(value1,index)
  {
    ...
    this.checkStatus(target,index)
    //console.log("this is value",target.target.value)
  }
...
:<></>} */}
        ...
        <div style={{paddingTop:"100px"}} className="d-flex justify-content-around">
          ...
          <div>
            ...
            <Button  onClick={() => {
                  ...
                  }} color="dark">Add Appointment</Button>
          </div>
        ...
        <Modal className="modal-xl" isOpen={this.state.large} >
         ...
         intervalDelay={0}
          ...
          <ModalBody style={{backgroundImage: `url(${Back})`,backgroundSize:"auto"}}>
                   ...
                   {this.state.appdate==="" && this.state.activeTab[0]==="2"?
<div className="pull-right">
                  <i class="motion fa fa-arrow-down pr-3" aria-hidden="true"></i>
                <strong>Add Appointment Date</strong>
              </div>
:<></>}
            <Nav tabs>
              <NavItem>
...
export default UnauthorizedAppointment;
