...
onSelectCalendar = () => {
  console.log(new Date(Date.parse(this.props.propdate)))
  let calendarApi = this.calendarComponentRef.current.getApi();
    calendarApi.gotoDate(new Date(Date.parse(this.props.propdate))); // call a method on the Calendar object
  // this.setState({
  //     jumpDate: gate,
...
SmsCheck=(e)=>{
 ...
 const index1=await this.state.empInfo.findIndex( (res)=>{
  ...
  return  res.id===parseInt(info.event._def.resourceIds[0])
...
this.setState({
  ...
  console.log(res2.data.data)
            ...
            // console.log(value2.employee_name)
            // console.log(value2.employee_id)
            //    const index1= this.state.empInfo.findIndex((res)=>{
                          
            //       return res.title===value2.employee_name
...
:<></>}
        ...
        <div >
          ...
          {/* <div className="sweet-loading text-center" style={{zIndex:"5",position:"absolute"}}>
        <ClipLoader
          css={override}
          size={150}
          color={"#123abc"}
          ...
          <div>
            <Button color="dark" onClick={()=>{this.onSelectCalendar()}}>
               ...
               Go to {new Intl.DateTimeFormat("en-GB", {
                  ...
                  month: "long",
                  day: "2-digit",
                }).format(new Date(Date.parse(this.props.propdate)))}
            </Button>
          </div>
                  ...
                  <Page style={styles.page}>
                    ...
                    <View style={styles.appointmentTitle}>
                      <Text style={styles.appointmentTitle}>
                        ...
                        {new Intl.DateTimeFormat("en-GB", {
                          ...
                          month: "long",
                          day: "2-digit",
                        }).format(new Date(this.state.reportstart))}{" "}
                        ...
                        {new Intl.DateTimeFormat("en-GB", {
                          ...
                          month: "long",
                          day: "2-digit",
                        }).format(new Date(this.state.reportend))}
                      </Text>
                      <Text>
                        -----------------------------------------------------------------------
                      </Text>
                    ...
                    {this.state.dailyreport.map((details,index) => (
                      <div>
                        ...
                        <View style={styles.appointmentDetailsDate}>
                          <Text style={styles.appointmentDetailsDate}>
                            <b>Appointment date: </b> {new Intl.DateTimeFormat("en-GB", {
                          year: "numeric",
                          month: "long",
                          day: "2-digit",
                        }).format(new Date(details.start))}
                          </Text>
                        </View>
                        ...
                        <View style={styles.appointmentDetails}>
                          <Text style={styles.appointmentDetails}>
                            <b>Employee Name:</b> {details.name}
                          </Text>
                        </View>

                        <View style={styles.appointmentDetails}>
                          <Text style={styles.appointmentDetails}>
                            <b>Appointment type:</b> {details.title}
                          </Text>
                        </View>
                        <View style={styles.appointmentDetails}>
                          <Text style={styles.appointmentDetails}>
                        ...
                        <View style={styles.appointmentDetails}>
                          <Text style={styles.appointmentDetails}>
                            Appointment Start Time: {new Date(details.start).getHours()+":"+new Date(details.start).getMinutes()}
                          </Text>
                        </View>
                        <View style={styles.appointmentDetails}>
                          <Text style={styles.appointmentDetails}>
                            Appointment End Time: {new Date(details.end).getHours()+":"+new Date(details.end).getMinutes()}
                          </Text>
                          <Text>
                            -----------------------------------------------------------------------
                          </Text>
