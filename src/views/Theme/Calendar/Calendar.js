...
res2.data.data.map(async value=>{
  ...
  await value.details.map(async value2=>{
   ...
   const index1=this.state.empInfo.findIndex((res)=>{
    ...
    const data=await {
      id:value.id,
      resourceId:this.state.empInfo[index1].id,
...
await this.setState({
  ...
  render() {
    ...
    return (
      ...
      <div>
            <p>
              Click in download button to generate a report of daily
              appointments
            </p>
                  ...
                  <Page style={styles.page}>
                    ...
                    {this.state.dailyreport.map((details) => (
                      <div>
                        ...
                        <View style={styles.appointmentDetails}>
                          <Text style={styles.appointmentDetails}>
                            Appointment type: {details.title}
                          </Text>
                        </View>
                        <View style={styles.appointmentDetails}>
                          <Text style={styles.appointmentDetails}>
                            Appointment Client: {details.client}
                          </Text>
                        </View>
                        <View style={styles.appointmentDetails}>
                          <Text style={styles.appointmentDetails}>
                            Appointment Start Time: {details.start}
                          </Text>
                        </View>
                        <View style={styles.appointmentDetails}>
                          <Text style={styles.appointmentDetails}>
                            Appointment End Time: {details.end}
                          </Text>
                          <Text>
                            -----------------------------------------------------------------------
                          </Text>
        ...
        <FullCalendar
          ...
          plugins={[resourceTimelinePlugin, timeGridPlugin, interactionPlugin,resourceTimeGridPlugin,scrollGridPlugin]}
